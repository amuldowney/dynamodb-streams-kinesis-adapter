...
//        when(mockClient.getRecords(any(GetRecordsRequestMapper.class))).thenReturn(getRecordsResult);
...
//        when(mockClient.getShardIterator(any(GetShardIteratorRequestAdapter.class))).thenReturn(getShardIteratorResult);
//        adapterClient.getShardIterator(new GetShardIteratorRequest());
//
//        verify(expectedResponseMetadata, times(1)).getRequestId();
//    }
