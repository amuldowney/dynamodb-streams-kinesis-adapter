...
//        AdapterRequestCache requestCache = new AdapterRequestCache(CACHE_SIZE);
//        requestCache.addEntry(null, new GetRecordsRequestMapper(new GetRecordsRequest()));
//    }
//
//    @Test(expected = IllegalArgumentException.class)
...
//        GetRecordsRequestMapper requestAdapter = new GetRecordsRequestMapper(request);
