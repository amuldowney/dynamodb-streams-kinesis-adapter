...
// * Copied as-is from KinesisClientLibrary.
// */
...
//                        new BigInteger(shard.sequenceNumberRange().startingSequenceNumber()).add(
...
//                    }
//                    String partitionKey =
//                        PARTITION_KEY_PREFIX + shard.shardId() + generateRandomString(PARTITION_KEY_LENGTH);
...
//                    String line = shard.shardId() + "," + sequenceNumber + "," + partitionKey + "," + data + ","
//                        + timestamp;
//
