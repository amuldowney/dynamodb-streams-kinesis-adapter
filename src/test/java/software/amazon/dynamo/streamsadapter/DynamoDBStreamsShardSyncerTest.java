...
//import software.amazon.dynamo.streamsadapter.util.ExceptionThrowingLeaseManager;
//import software.amazon.dynamo.streamsadapter.util.KinesisLocalFileDataCreator;
//import software.amazon.dynamo.streamsadapter.util.KinesisLocalFileProxy;
//import software.amazon.dynamo.streamsadapter.util.ShardObjectHelper;
...
//
///*
// * Copied from com.amazonaws.services.kinesis.clientlibrary.lib.worker.ShardSyncerTest and modified for DDB Streams
...
//    protected static final LeaseCleanupValidator leaseCleanupValidator = new StreamsLeaseCleanupValidator();
//    private static final DynamoDBStreamsShardSyncer shardSyncer = new DynamoDBStreamsShardSyncer(leaseCleanupValidator);
//    /**
...
//                    ExceptionThrowingLeaseManager.ExceptionThrowingLeaseManagerMethods.DELETELEASE, c, INITIAL_POSITION_TRIM_HORIZON);
...
//        for (int c = 1; c <= maxCallingCount; c = c + 2) {
//            testCheckAndCreateLeasesForNewShardsAtSpecifiedPositionAndClosedShardImpl(
//                    ExceptionThrowingLeaseManager.ExceptionThrowingLeaseManagerMethods.LISTLEASES, c, INITIAL_POSITION_TRIM_HORIZON);
//            // Need to clean up lease manager every time after calling ShardSyncer
//            leaseManager.deleteAll();
//        }
//    }
...
//        for (int c = 1; c <= maxCallingCount; c = c + 2) {
//            testCheckAndCreateLeasesForNewShardsAtSpecifiedPositionAndClosedShardImpl(
//                    ExceptionThrowingLeaseManager.ExceptionThrowingLeaseManagerMethods.CREATELEASEIFNOTEXISTS, c,INITIAL_POSITION_TRIM_HORIZON);
//            // Need to clean up lease manager every time after calling ShardSyncer
//            leaseManager.deleteAll();
//        }
//    }
...
//                                                      ExceptionThrowingLeaseManager.ExceptionThrowingLeaseManagerMethods exceptionMethod,
...
//        for (int c = 1; c <= maxCallingCount; c = c + 2) {
//            testCheckAndCreateLeasesForNewShardsAtSpecifiedPositionAndClosedShardImpl(
//                    ExceptionThrowingLeaseManager.ExceptionThrowingLeaseManagerMethods.DELETELEASE,
...
//        for (int c = 1; c <= maxCallingCount; c = c + 2) {
//            testCheckAndCreateLeasesForNewShardsAtSpecifiedPositionAndClosedShardImpl(
//                    ExceptionThrowingLeaseManager.ExceptionThrowingLeaseManagerMethods.LISTLEASES,
//                    c, INITIAL_POSITION_AT_TIMESTAMP);
//            // Need to clean up lease manager every time after calling ShardSyncer
//            leaseManager.deleteAll();
//        }
...
//        for (int c = 1; c <= maxCallingCount; c = c + 2) {
//            testCheckAndCreateLeasesForNewShardsAtSpecifiedPositionAndClosedShardImpl(
//                    ExceptionThrowingLeaseManager.ExceptionThrowingLeaseManagerMethods.CREATELEASEIFNOTEXISTS,
//                    c, INITIAL_POSITION_AT_TIMESTAMP);
//            // Need to clean up lease manager every time after calling ShardSyncer
//            leaseManager.deleteAll();
//        }
...
//        Assert.assertNotNull(leaseManager.getLease(closedShardId));
//
//        // leases for both children exists, one is at TRIM_HORIZON, other at some intermediate sequence number.
...
//        // nor at SHARD_END, but are being processed at some intermediate sequence number.
//        childLease2.setCheckpoint(new ExtendedSequenceNumber("43789"));
//        leaseManager.updateLease(childLease2);
//        shardSyncer.cleanupLeaseForClosedShard(closedShardId, childShardIds, trackedLeaseMap, leaseManager);
//        Assert.assertNotNull(leaseManager.getLease(closedShardId));
//
//        // leases for both children exists, both are at SHARD_END,
//        // so parent lease (closedShardId) will now be deleted from the leases table..
//        childLease1.setCheckpoint(ExtendedSequenceNumber.SHARD_END);
//        leaseManager.updateLease(childLease1);
//        childLease2.setCheckpoint(ExtendedSequenceNumber.SHARD_END);
//        leaseManager.updateLease(childLease2);
//        shardSyncer.cleanupLeaseForClosedShard(closedShardId, childShardIds, trackedLeaseMap, leaseManager);
//        Assert.assertNull(leaseManager.getLease(closedShardId));
//    }
