...
public class DynamoDBStreamsProxy implements ShardDetector {
    ...
    //    }
    //    final GetShardIteratorRequest getShardIteratorRequest = GetShardIteratorRequest.builder()
    ...
    //        .build();
    //
    //    final GetShardIteratorResponse response = client.getShardIterator(getShardIteratorRequest).join();
    ...
    //DOESN'T SEEM TO BE USED EXTERNALLY, WE DON'T NEED IT?
    //@Override public ListShardsResponse getListShardsResponse(ListShardsRequest request) {
    //   return client.listShards(request).join();
    //}
