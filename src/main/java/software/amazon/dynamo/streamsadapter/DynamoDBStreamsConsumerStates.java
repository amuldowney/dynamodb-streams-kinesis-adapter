...
//  /**
//   * Represents the current state of the consumer. This handles the creation of tasks for the consumer, and what to
...
//     *
//     * @param consumerArgument configuration specific to the task being created
//     * @param consumer         the consumer to use build the task, or execute state.
//     * @param input            the process input received, this may be null if it's a control message
...
//     *
//     * @param shutdownReason the reason that a shutdown was requested
//     * @return the next state that the consumer should transition to, this may be the same object as the current
//     * state.
//     */
